...
class Thermostat(Simulator):
    ...
    def __init__(self, initial_temp=20.0, heater_temp=35.0, heat_coefficient=1.0, entropy=0.2):
    ...
    def step(self, dt: float):
        ...
        """
        delta_temp = self._flow * self._heat_coefficient * (self._heater_temp - self._temp)
